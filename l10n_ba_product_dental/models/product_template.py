...
class ProductTemplate(models.Model):
    ...
    manufacturer_id = fields.Many2one(comodel_name="res.partner", string="Proizvođač")
    keep_temp_from = fields.Integer(string="Skladištenje(°C):") 
    keep_temp_to = fields.Integer(string="do:") 

    klasa = fields.Selection(
        selection=[
            ("I", "I"),
            ("Is", "Is"),
            ("IIa", "IIa"),
    ...
    keep_temp_from = fields.Integer(
        compute="_compute_dental_ba_info",
        inverse="_inverse_dental_ba_info",
        store=True,
        string="Skladištenje(°C) od:"
    ) 
    keep_temp_to = fields.Integer(
        compute="_compute_dental_ba_info",
        inverse="_inverse_dental_ba_info",
        store=True,
        string="do:"
    ...
    manufacturer_pname = fields.Char(
        ...
        inverse="_inverse_dental_ba_info",
        store=True,
        string="Proizvođač ime proizvoda",
    )
    manufacturer_pref = fields.Char(
        compute="_compute_dental_ba_info",
        inverse="_inverse_dental_ba_info",
        store=True,
        string="Proizvođač kod",
    )
    manufacturer_purl = fields.Char(
        compute="_compute_dental_ba_info",
        inverse="_inverse_dental_ba_info",
        store=True,
        string="Proizvođač URL proizvoda",
    )
    ...
    def _compute_dental_ba_info(self):
    ...
    def _inverse_dental_ba_info(self):
